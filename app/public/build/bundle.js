...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$3, 33, 2, 781);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "any");
    			add_location(input1, file$3, 34, 2, 821);
    			add_location(span, file$3, 35, 2, 888);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 37, 2, 956);
    			add_location(form, file$3, 32, 0, 736);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			input = element("input");
    			add_location(button0, file, 45, 4, 1667);
    			add_location(button1, file, 46, 4, 1717);
    			attr_dev(input, "type", "file");
    			add_location(input, file, 47, 4, 1767);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	function income_income_binding(value) {
    		/*income_income_binding*/ ctx[11](value);
    	}
    ...
    function create_if_block(ctx) {
    	...
    	function spending_budgetItems_binding(value) {
    		/*spending_budgetItems_binding*/ ctx[10](value);
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(41:2) {#if currentTab == \\\"Spending\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*currentTab*/ ctx[2] == "Advanced") return 2;
    		return -1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file, 36, 4, 1245);
    			add_location(li1, file, 37, 4, 1306);
    			add_location(li2, file, 38, 4, 1363);
    			add_location(ul, file, 35, 2, 1236);
    			attr_dev(main, "class", "svelte-1e01gka");
    			add_location(main, file, 34, 0, 1227);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(li0, "click", /*click_handler*/ ctx[7], false, false, false, false),
    					listen_dev(li1, "click", /*click_handler_1*/ ctx[8], false, false, false, false),
    					listen_dev(li2, "click", /*click_handler_2*/ ctx[9], false, false, false, false)
    				];
