...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	let t_value = JSON.stringify(/*income*/ ctx[0]) + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*income*/ 1 && t_value !== (t_value = JSON.stringify(/*income*/ ctx[0]) + "")) set_data_dev(t, t_value);
    		},
    		i: noop,
    		o: noop,
    ...
    class Income extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { income: 0 });
    ...
    const file$3 = "src\\components\\RateSelector.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 6, 4, 152);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$3, 4, 0, 92);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	function income_income_binding(value) {
    		/*income_income_binding*/ ctx[9](value);
    	}
    ...
    function create_if_block(ctx) {
    	...
    	function spending_budgetItems_binding(value) {
    		/*spending_budgetItems_binding*/ ctx[8](value);
    	}
    	...
    	spending.$on("spending-saved", /*save*/ ctx[3]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(36:2) {#if currentTab == \\\"Spending\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*currentTab*/ ctx[2] == "Spending") return 0;
    		if (/*currentTab*/ ctx[2] == "Income") return 1;
    		return -1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			input = element("input");
    			add_location(li0, file, 32, 4, 1136);
    			add_location(li1, file, 33, 4, 1201);
    			add_location(ul, file, 31, 2, 1127);
    			add_location(button0, file, 40, 2, 1473);
    			add_location(button1, file, 41, 2, 1521);
    			attr_dev(input, "type", "file");
    			add_location(input, file, 42, 2, 1569);
    			attr_dev(main, "class", "svelte-1e01gka");
    			add_location(main, file, 30, 0, 1118);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(li0, "click", /*click_handler*/ ctx[6], false, false, false, false),
    					listen_dev(li1, "click", /*click_handler_1*/ ctx[7], false, false, false, false),
    					listen_dev(button0, "click", /*exportJson*/ ctx[4], false, false, false, false),
    					listen_dev(button1, "click", /*importJson*/ ctx[5], false, false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(2, currentTab = "Spending");
    	const click_handler_1 = () => $$invalidate(2, currentTab = "Income");
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('importData' in $$props) $$invalidate(1, importData = $$props.importData);
